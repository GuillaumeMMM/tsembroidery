...
const FLOWERS_PES = new URL("./fixtures/flowers.pes", import.meta.url);
const FLOWERS_SVG = new URL("./flowers.svg", import.meta.url);
...
test("pesToSvg: flowers.pes matches the committed golden SVG", () => {
  // tests/flowers.svg was generated by this library and visually
